      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="panel">
          <div className="panel-header flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
            <h3 className="font-semibold text-foreground text-sm sm:text-base">Consultation History</h3>
            <button className="w-full sm:w-auto px-4 py-2 bg-primary text-primary-foreground rounded-xl text-xs font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-2">
              ...
              <div key={i} className="flex items-start gap-4 p-4 rounded-xl border border-border hover:bg-muted/30 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-1 sm:gap-2">
                    <div>
                      <p className="text-xs sm:text-sm font-medium text-foreground">{c.diagnosis}</p>
